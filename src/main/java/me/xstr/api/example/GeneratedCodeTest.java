...
/**
 * Test class to verify the generated OpenAPI client code compiles and works correctly.
...
public class GeneratedCodeTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("✓ HealthResponse model class instantiated: " + healthResponse.getClass().getSimpleName());
            System.out.println("✓ VersionResponse model class instantiated: " + versionResponse.getClass().getSimpleName());
